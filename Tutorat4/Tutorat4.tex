  ...
  \begin{frame}[allowframebreaks, fragile]{Organisation}
    \begin{itemize}
      ...
      \item \alert{get the slides before the exercise class:} \url{https://github.com/matthejue/Einfuehrung_in_ESE_Tutoratsfolien_out}
        \begin{itemize}
          \item \alert{warning:} the slides often \aalert{get changed} just \aalert{shortly before} the exercise class. Both the lecture and the exercise classes are pretty \aalert{running edge}
        \end{itemize}
    \end{itemize}
  \end{frame}
}\fi
