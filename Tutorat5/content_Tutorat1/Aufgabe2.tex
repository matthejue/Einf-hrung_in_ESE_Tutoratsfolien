...
\begin{frame}[allowframebreaks]{Task 2}{}
  \begin{solutionnoinc}
    \begin{ganttchart}[
      ...
      \ganttbar[bar/.style={fill=red, fill opacity=0.3}]{1 (c=1)}{0}{7}\\

      \ganttgroup[inline=false]{$T_{2}$}{0}{1}
      \ganttbar[bar/.style={fill=orange, fill opacity=0.3}]{2 (c=6)}{2}{11}\\

      \ganttgroup[inline=false]{$T_{3}$}{0}{1}
      \ganttbar[bar/.style={fill=yellow, fill opacity=0.3}]{3 (c=8)}{6}{9}\\

      \ganttgroup[inline=false]{$T_{4}$}{0}{1}
      \ganttbar[bar/.style={fill=green, fill opacity=0.3}]{4 (c=2)}{8}{19}\\

      \ganttgroup[inline=false]{$T_{5}$}{0}{1}
      \ganttbar[bar/.style={fill=blue, fill opacity=0.3}]{5 (c=5)}{10}{24}\\

      \ganttgroup[inline=false]{$T_{6}$}{0}{1}
      \ganttbar[bar/.style={fill=cyan, fill opacity=0.3}]{6 (c=3)}{11}{14}
  ...
  \begin{solutionnoinc}
    \begin{ganttchart}[
      ...
      \ganttgroup[inline=false]{$T_{1}$}{0}{1}
      \ganttbar[bar/.style={fill=red, fill opacity=0.3}]{1 (c=1)}{0}{5}\\

      \ganttgroup[inline=false]{$T_{2}$}{0}{1}
      \ganttbar[bar/.style={fill=orange, fill opacity=0.3}]{2 (c=6)}{2}{7}\\

      \ganttgroup[inline=false]{$T_{4}$}{0}{1}
      \ganttbar[bar/.style={fill=green, fill opacity=0.3}]{4 (c=2)}{6}{15}\\

      \ganttgroup[inline=false]{$T_{5}$}{0}{1}
      \ganttbar[bar/.style={fill=blue, fill opacity=0.3}]{5 (c=5)}{6}{20}\\

      \ganttgroup[inline=false]{$T_{6}$}{0}{1}
      \ganttbar[bar/.style={fill=cyan, fill opacity=0.3}]{6 (c=3)}{7}{10}
    \end{ganttchart}
  \end{solutionnoinc}
  \begin{solutionnoinc}
    \scriptsize
  ...
  \begin{solutionnoinc}
    \begin{ganttchart}[
      ...
      \ganttgroup[inline=false]{$T_{1}$}{0}{1}
      \ganttbar[bar/.style={fill=red, fill opacity=0.3}]{1 (c=1)}{0}{1}\\

      \ganttgroup[inline=false]{$T_{4}$}{0}{1}
      \ganttbar[bar/.style={fill=green, fill opacity=0.3}]{4 (c=2)}{2}{6}\\

      \ganttgroup[inline=false]{$T_{5}$}{0}{1}
      \ganttbar[bar/.style={fill=blue, fill opacity=0.3}]{5 (c=5)}{2}{11}\\
    \end{ganttchart}
  \end{solutionnoinc}
  \begin{solutionnoinc}
    \begin{itemize}
  ...
  \begin{solution}
    \begin{tikzpicture}
      \begin{axis}[x=0.4cm, y=2cm, xtick={0, 2, ..., 25}, ytick={0, 0.5, ...,2}, axis lines=left,
        ...
        ylabel=$frequency (100 MHz)$, ylabel style={rotate=-90,at={(0.1,1)}, anchor=south}
        ]
      \addplot [
        ybar interval,
        xtick=data,
...
\begin{frame}[allowframebreaks]{Task 2}{}
  ...
  \begin{solutionnoinc}
    \begin{ganttchart}[
      ...
      \ganttgroup[inline=false]{$T_{1}$}{0}{1}
      \ganttbar[bar/.style={fill=red, fill opacity=0.3}]{1 (c=0.75)}{2}{7}\\
  ...
  \begin{solutionnoinc}
    \begin{itemize}
      ...
      \item $\displaystyle T = \frac{0.75}{0.675} \approx 1.11$
    \end{itemize}
  \end{solutionnoinc}
  \framebreak
  \begin{solutionnoinc}
    \begin{ganttchart}[
      ...
      \ganttgroup[inline=false]{$T_{2}$}{0}{1}
      \ganttbar[bar/.style={fill=orange, fill opacity=0.3}]{2 (c=4.05)}{6}{11}\\
  ...
  \begin{solutionnoinc}
    \begin{itemize}
      ...
      \item $G([6, 12]) = \frac{6 - (0.675 \cdot (4 - 1.111)) + 8}{6} = 2.01$
    \end{itemize}
  \end{solutionnoinc}
  \begin{solutionnoinc}
    \begin{tikzpicture}
