...
\newcommand{\titlesecond}{ Scheduling Periodic and Mixed Task Sets }
\newcommand{\subtitlesecond}{Dynamic Voltage Scaling and Dynamic Power Management, Dynamic Voltage Scaling for Real-Time Tasks, Dynamic Power Management}
\newcommand{\type}{
  Exercise class 7\\[-0.25cm]
  \rule{8cm}{0.1mm}
}
