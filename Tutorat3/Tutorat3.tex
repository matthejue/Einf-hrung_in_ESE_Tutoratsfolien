...
\if\pascal0{
  \begin{frame}[allowframebreaks, fragile]{Organisation}
    \begin{itemize}
      ...
      \begin{figure}
        \centering
        \includegraphics[height=0.6\paperheight]{./figures/feedback.png}
      \end{figure}
    \end{itemize}
  \end{frame}
  ...
  \begin{frame}[allowframebreaks]{Organisation}
    \begin{itemize}
      \item \alert{Question:} Periodic schedule for framesize $f=2$ for \alert{task 3} of \alert{sheet 2}
    \end{itemize}
    \includegraphics[width=\textwidth]{./figures/framesize2.png}
  \end{frame}
}\fi
...
\include{./content_Tutorat1/Aufgabe5}
