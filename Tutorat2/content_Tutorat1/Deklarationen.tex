...
\begin{block}#2{Task \thesection{.}\thetask:\enspace\ignorespaces #1 \notebook}}{\end{block}}

\newenvironment<>{solution}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=PrimaryColor}%
\begin{block}#2{Solution \alph{task}:\enspace\ignorespaces #1 \anotebook}\itshape}{\end{block}\stepcounter{task}}

\newenvironment<>{solutionnoinc}[1][]{%
  \setbeamercolor{block title}{fg=white,bg=PrimaryColor}%
\begin{block}#2{Solution \alph{task}:\enspace\ignorespaces #1 \anotebook}\itshape}{\end{block}}
