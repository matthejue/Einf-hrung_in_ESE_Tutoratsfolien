...
\newcommand{\titlesecond}{Introduction}
\newcommand{\subtitlesecond}{Topic 1, Topic 2, Topic 3}
\newcommand{\type}{
  Exercise class 1\\[-0.25cm]
  \rule{8cm}{0.1mm}
}
\newcommand{\authorsecond}{
  \if\pascal{Pascal Walter}\else{Jürgen Mattheis}\fi
}
...
\begin{column}{0.5\textwidth}
  ...
  \if\pascal{Jürgen Mattheis}\else{Pascal Walter}\fi
\end{column}
\begin{column}{0.5\textwidth}
  \raggedleft
  \small
