...
\newcommand{\titlesecond}{Energy and Power}
\newcommand{\subtitlesecond}{Energy Harvesting, Solar Cell Characteristics and Maximum Power Point Tracking, Application Control}
\newcommand{\type}{
  Exercise class 8\\[-0.25cm]
  \rule{8cm}{0.1mm}
}
