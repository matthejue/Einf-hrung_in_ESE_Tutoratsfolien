...
\newcommand{\titlesecond}{Architecture Synthesis I}
\newcommand{\subtitlesecond}{Scheduling with Pipeline Resources, Integer Linear Programming, Iterative Algorithms}
\newcommand{\type}{
  Exercise class 10\\[-0.25cm]
  \rule{8cm}{0.1mm}
}
